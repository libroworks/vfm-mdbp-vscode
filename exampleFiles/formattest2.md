...
##### h5 sectionizeあいうえ
ここにページをまたぐ長い本文があるとする。

##### h5 sectionize コラム：コラムタイトル {.column}
dateオブジェクトだけで2週間分の日付を作ろうとするとうまくいきません。**その月の最終日を越えた日付、バリューエラーが発生してしまうからです**。そこで、目的の日付を作ります。
